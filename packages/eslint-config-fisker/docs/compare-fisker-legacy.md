...
| [unicorn/no-for-loop](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-for-loop.md)                                             |  warn  |      off      |
| [unicorn/prefer-exponentiation-operator](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-exponentiation-operator.md)       | error  |      off      |
| [unicorn/prefer-starts-ends-with](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-starts-ends-with.md)                     | error  |      off      |
...
| [unicorn/catch-error-name](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/catch-error-name.md)                                   | error  |     error     |
| [unicorn/custom-error-definition](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/custom-error-definition.md)                     |  off   |      off      |
| [unicorn/error-message](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/error-message.md)                                         | error  |     error     |
| [unicorn/escape-case](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/escape-case.md)                                             | error  |     error     |
| [unicorn/explicit-length-check](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/explicit-length-check.md)                         | error  |     error     |
| [unicorn/filename-case](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/filename-case.md)                                         | error  |     error     |
| [unicorn/import-index](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/import-index.md)                                           | error  |     error     |
| [unicorn/new-for-builtins](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/new-for-builtins.md)                                   | error  |     error     |
| [unicorn/no-abusive-eslint-disable](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-abusive-eslint-disable.md)                 | error  |     error     |
| [unicorn/no-array-instanceof](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-array-instanceof.md)                             | error  |     error     |
| [unicorn/no-console-spaces](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-console-spaces.md)                                 | error  |     error     |
| [unicorn/no-fn-reference-in-iterator](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-fn-reference-in-iterator.md)             |  off   |      off      |
| [unicorn/no-for-loop](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-for-loop.md)                                             |  warn  |      off      |
| [unicorn/no-hex-escape](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-hex-escape.md)                                         | error  |     error     |
| [unicorn/no-new-buffer](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-new-buffer.md)                                         | error  |     error     |
| [unicorn/no-process-exit](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-process-exit.md)                                     | error  |     error     |
| [unicorn/no-unreadable-array-destructuring](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-unreadable-array-destructuring.md) | error  |     error     |
| [unicorn/no-unsafe-regex](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-unsafe-regex.md)                                     |  off   |      off      |
| [unicorn/no-unused-properties](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-unused-properties.md)                           |  off   |      off      |
| [unicorn/no-zero-fractions](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/no-zero-fractions.md)                                 | error  |     error     |
...
| [unicorn/prefer-add-event-listener](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-add-event-listener.md)                 |  off   |      off      |
| [unicorn/prefer-exponentiation-operator](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-exponentiation-operator.md)       | error  |      off      |
| [unicorn/prefer-includes](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-includes.md)                                     | error  |     error     |
| [unicorn/prefer-node-append](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-node-append.md)                               |  off   |      off      |
| [unicorn/prefer-node-remove](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-node-remove.md)                               |  off   |      off      |
| [unicorn/prefer-query-selector](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-query-selector.md)                         |  off   |      off      |
| [unicorn/prefer-spread](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-spread.md)                                         |  off   |      off      |
| [unicorn/prefer-starts-ends-with](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-starts-ends-with.md)                     | error  |      off      |
| [unicorn/prefer-text-content](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-text-content.md)                             | error  |     error     |
| [unicorn/prefer-type-error](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prefer-type-error.md)                                 | error  |     error     |
| [unicorn/prevent-abbreviations](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/prevent-abbreviations.md)                         |  off   |      off      |
| [unicorn/regex-shorthand](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/regex-shorthand.md)                                     |  warn  |     warn      |
| [unicorn/throw-new-error](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v8.0.0/docs/rules/throw-new-error.md)                                     | error  |     error     |
