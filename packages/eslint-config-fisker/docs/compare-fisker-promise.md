...
| :--------------------------------------------------------------------------------------------------------------------- | :----: | :-----------------: |
| [promise/always-return](https://github.com/xjamundx/eslint-plugin-promise/tree/v4.1.1/docs/rules/always-return.md)     |  off   |        error        |
| [promise/catch-or-return](https://github.com/xjamundx/eslint-plugin-promise/tree/v4.1.1/docs/rules/catch-or-return.md) |  off   |        error        |
